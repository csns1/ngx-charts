(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/cdk/portal'), require('d3-selection'), require('d3-brush'), require('d3-scale'), require('@angular/platform-browser'), require('d3-shape'), require('d3-array'), require('d3-interpolate'), require('d3-format'), require('d3-color'), require('d3-hierarchy'), require('d3-time-format')) :
    typeof define === 'function' && define.amd ? define('@swimlane/ngx-charts', ['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/cdk/portal', 'd3-selection', 'd3-brush', 'd3-scale', '@angular/platform-browser', 'd3-shape', 'd3-array', 'd3-interpolate', 'd3-format', 'd3-color', 'd3-hierarchy', 'd3-time-format'], factory) :
    (global = global || self, factory((global.swimlane = global.swimlane || {}, global.swimlane['ngx-charts'] = {}), global.ng.core, global.ng.common, global.ng.animations, global.ng.cdk.portal, global.d3Selection, global.d3Brush, global.d3Scale, global.ng.platformBrowser, global.d3Shape, global.d3Array, global.d3Interpolate, global.d3Format, global.d3Color, global.d3Hierarchy, global.d3TimeFormat));
}(this, (function (exports, core, common, animations, portal, d3Selection, d3Brush, d3Scale, platformBrowser, d3Shape, d3Array, d3Interpolate, d3Format, d3Color, d3Hierarchy, d3TimeFormat) { 'use strict';
